...
import org.fsj.demo.config.ProjectUrlConfig;
import org.fsj.demo.enums.ResultEnum;
import org.fsj.demo.exception.SellException;
import org.fsj.demo.util.PropertiesUtil;
...
public class WechatController {
    ...
    public String  authorize(@RequestParam("returnUrl") String returnUrl) throws UnsupportedEncodingException {
        String url = projectUrlConfig.wechatMpAuthorize;
        String redirectURL = wxMpService.oauth2buildAuthorizationUrl(PropertiesUtil.getProperty("WechatUrl"),
                WxConsts.OAUTH2_SCOPE_USER_INFO, URLEncoder.encode(returnUrl,"UTF-8"));
